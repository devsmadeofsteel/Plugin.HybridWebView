...
namespace SampleApp.Views
{
    ...
    {
        NavigationStringSampleViewModel ViewModel = new NavigationStringSampleViewModel();
        ...
        private void HybridWebViewControl_OnOnNavigationCompleted(object sender, string e)
        {
